...
We operate the mobile application Calo (the "**App**"), as well as any other related products and services that refer or link to these legal terms (the "**Legal Terms**") (collectively, the "**Services**").

  

Calo is an AI-powered calorie tracker designed to help Users estimate the nutritional content of their meals by uploading pictures of food. The App provides calorie estimates and other nutritional information based on AI analysis. Important Note: Calo is not a substitute for professional medical advice, diagnosis, or treatment.
...
Cancel through the App Store. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at ambi.design.co@gmail.com.  
